...
<body>
            ...
            <nav class="navbar navbar-inverse" role="navigation">
                ...
                <div id="main-nav" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav" id="mainNav">
                        ...
                        <li><a href="#hotnews" class="scroll-link">Berita</a></li>
    ...
    <section id="hotnews" class="page-section darkBg pDark pdingBtm30">
        <div class="container">
            <div class="heading text-center">
                <!-- Heading -->
                <h2><i class="fa fa-fire color"></i> Berita</h2><center><hr style="width:15%;"></center>
            </div>
            <?php
                $no         =   1; 
    ...
    <section id="profile" class="page-section" style="background:#222222;">
        <div class="container">
            <div class="heading text-center">
                <!-- Heading -->
                <h2><i class="fa fa-user color"></i> Tentang</h2><center><hr style="width:15%;"></center>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <p>        
                        <label style="padding-right:70px;">Sekolah</label> : SMP Negeri 1 Turi<br>
                    </p>
                </div>
                <?php 
